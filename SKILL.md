...
去 AI 味先看句子，再看词。一句话通不通、人会不会这么说出口，这是判据本身。下面那些词表是第二道，它们把最常犯的案例固定下来，省得每次重新推导。词表没命中不代表这句干净——压缩型、电报型、没主语的 AI 味，词表里一个都查不到。
...
Hard Bans 各节和 Before Returning 清单。两道都要过，顺序不能反：先按第一道把句子改成人话，再用词表扫一遍捡漏。反过来做，注意力会全落在查词上，整句不通的地方反而漏掉。

有几个词已经按第五问推导定案，列成无条件禁用，不用每次重新判断：`写死`（黄佬原话「这个永远不要写」）和「动词 + 死」那一族。这是为了省事，词表的地位还是第二道。
...
先把「判断顺序」第一道的句子体检做完，再扫下面这张表。这张表只抓已知的词，抓不到没主语、没动词、虚词被压掉的句子。
